...
document.getElementById('script-select')!.addEventListener('change', function() {
    var script = (document.getElementById('script-select') as HTMLInputElement).value;
    if (script === 'jira-copy') {
...
document.getElementById('download-btn')!.addEventListener('click', function() {
    var htmlText = (document.getElementById('html-text') as HTMLInputElement).value;
    var htmlLink = (document.getElementById('html-link') as HTMLInputElement).value;
    var plainText = (document.getElementById('plain-text') as HTMLInputElement).value;
